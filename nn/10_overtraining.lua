...
network = construct_neural_network(INPUT_NEURONS, HIDDEN_NEURONS_LAYER_1, HIDDEN_NEURONS_LAYER_2, OUTPUT_NEURONS)
...
prepare_graph("xor_c1.png", -1/2, 1/2, 21, -0.5)
prepare_graph("xor_c2.png", -1/2, 1/2, 21, 0.5)
prepare_graph("xor_c3.png", -10, 10, 21, 0.5)
